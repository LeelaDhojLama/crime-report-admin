package com.example.crimereport.maphelper;
...
public class GPSPath extends AsyncTask<String, Void, PolylineOptions> {
    private String TAG = "GetPathFromLocation";
    private String API_KEY = "Place_Your_API_Key";
    private LatLng source, destination;
    private DirectionPointListener resultCallback;

    public GPSPath(LatLng source, LatLng destination, DirectionPointListener resultCallback) {
        this.source = source;
    ...
    public String getUrl(LatLng origin, LatLng dest) {
        ...
        String output = "json";
        String url = "https://maps.googleapis.com/maps/api/directions/" + output + "?" + parameters + "&key=AIzaSyAEGx7PENVwwD_4DXqgSNHxaVGNvFwXrEA";
